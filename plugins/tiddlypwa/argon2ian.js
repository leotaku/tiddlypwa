...
(function () {
	...
	class n {
		...
		constructor() {
			this.#s.onmessage = (e) => {
				const [t, s, o] = e.data, [r, n] = this.#t.get(t);
				this.#t.delete(t), (s ? r : n)(o);
			};
		}
		hash(e, t, s) {
		...
		verify(e, t, s, o) {
			return new Promise((r, n) => {
				this.#t.set(this.#e, [r, n]), this.#s.postMessage([this.#e, !0, e, t, s, o]), this.#e++;
			});
		}
		terminate() {
			this.#s.terminate();
